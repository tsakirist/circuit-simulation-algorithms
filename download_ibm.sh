...
case $FILE in
    "ibm1" )
        if [ -f "ibmpg1.spice" ]; then
            ...
            wget https://web.ece.ucsb.edu/~lip/PGBenchmarks/ibmpg/ibmpg1.spice.bz2
        ...
        if [ -f "ibmpg1.solution" ]; then
            ...
            wget https://web.ece.ucsb.edu/~lip/PGBenchmarks/ibmpg/ibmpg1.solution.bz2
    ...
    "ibm2" )
        if [ -f "ibmpg2.spice" ]; then
            ...
            wget https://web.ece.ucsb.edu/~lip/PGBenchmarks/ibmpg/ibmpg2.spice.bz2
        ...
        if [ -f "ibmpg2.solution" ]; then
            ...
            wget https://web.ece.ucsb.edu/~lip/PGBenchmarks/ibmpg/ibmpg2.solution.bz2
    ...
    "ibm3" )
        if [ -f "ibmpg3.spice" ]; then
            ...
            wget https://web.ece.ucsb.edu/~lip/PGBenchmarks/ibmpg/ibmpg3.spice.bz2
        ...
        if [ -f "ibmpg3.solution" ]; then
            ...
            wget https://web.ece.ucsb.edu/~lip/PGBenchmarks/ibmpg/ibmpg3.solution.bz2
    ...
    "ibm4" )
        if [ -f "ibmpg4.spice" ]; then
            ...
            wget https://web.ece.ucsb.edu/~lip/PGBenchmarks/ibmpg/ibmpg4.spice.bz2
        ...
        if [ -f "ibmpg4.solution" ]; then
            ...
            wget https://web.ece.ucsb.edu/~lip/PGBenchmarks/ibmpg/ibmpg4.solution.bz2
    ...
    "ibm5" )
        if [ -f "ibmpg5.spice" ]; then
            ...
            wget https://web.ece.ucsb.edu/~lip/PGBenchmarks/ibmpg/ibmpg5.spice.bz2
        ...
        if [ -f "ibmpg5.solution" ]; then
            ...
            wget https://web.ece.ucsb.edu/~lip/PGBenchmarks/ibmpg/ibmpg5.solution.bz2
    ...
    "ibm6" )
        if [ -f "ibmpg6.spice" ]; then
            ...
            wget https://web.ece.ucsb.edu/~lip/PGBenchmarks/ibmpg/ibmpg6.spice.bz2
        ...
        if [ -f "ibmpg6.solution" ]; then
            ...
            wget https://web.ece.ucsb.edu/~lip/PGBenchmarks/ibmpg/ibmpg6.solution.bz2
